...
class HarDataset(Dataset):
    ...
    def load_labels(self):
        ...
        y = (
            np.loadtxt(labels_file).astype(int).squeeze() - 1
...
class WisdmDataset(Dataset):
    def __init__(self, data_dir: Path, window_size=128, overlap=0.5, transform=None):
        ...
        raw_file = (
            self.data_dir / f"WISDM_ar_latest/WISDM_ar_v1.1/WISDM_ar_v1.1_raw.txt"
        )
